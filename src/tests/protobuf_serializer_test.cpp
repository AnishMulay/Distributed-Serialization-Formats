...
void test_metadata_serialization_deserialization() {
    ...
    std::cout << "Serialized metadata to " << serialized.size() << " bytes (Protocol Buffers)" << std::endl;
...
void test_block_serialization_deserialization() {
    ...
    for (size_t size : sizes) {
        ...
        std::cout << "Serialized block of size " << size << " bytes to " 
                  << serialized.size() << " bytes (Protocol Buffers)" << std::endl;
...
int main() {
    std::cout << "Running Protocol Buffers serializer tests..." << std::endl;
